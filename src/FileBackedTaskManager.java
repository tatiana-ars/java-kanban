    ...
    private String toString(Task task) {
        if (task instanceof Subtask) {
            ...
            return String.format("%d,%s,%s,%s,%s,%d",
                    task.getId(), "SUBTASK", task.getName(), task.getStatus(), task.getDescription(), subtask.getEpicId());
        } else if (task instanceof Epic) {
            return String.format("%d,%s,%s,%s,%s,", task.getId(), "EPIC", task.getName(), task.getStatus(), task.getDescription());
        } else {
            return String.format("%d,%s,%s,%s,%s,", task.getId(), "TASK", task.getName(), task.getStatus(), task.getDescription());
        }
    }
